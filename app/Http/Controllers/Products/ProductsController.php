...
/**
 * Check if fitment filter should apply
 */
protected function shouldApplyFitmentFilter(Request $request): bool
{
    return $request->cookie('engine_id') !== null && $request->type !== 'clear';
}
