                        ...
                        <div class="d-flex">
                            <div class="form-check">
                                <label  class="custom-control-label" for="<?php echo e($ob->slug); ?>-<?php echo e($engine->id); ?>">
                                    <input  
                                        data-slug="<?php echo e($ob->slug); ?>"
                                        data-name="<?php echo e($ob->name); ?>"
                                        class="form-check-input engine-<?php echo e($ob->slug); ?>" 
                                        value="<?php echo e($engine->id); ?>" 
                                        type="checkbox" 
                                        id="<?php echo e($ob->slug); ?>-<?php echo e($engine->id); ?>" 
                                        name="engine_id[<?php echo e($ob->id); ?>][]" 
                                        <?php echo e($helper->check($product->engines, $ob->id, true, $engine->id)); ?> 
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/autofactorng/resources/views/includes/edit_children.blade.php ENDPATH**/ ?>