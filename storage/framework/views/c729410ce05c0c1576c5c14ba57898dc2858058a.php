    ...
    <div class="d-flex">
        <div class="form-check ">
            <label class="custom-control-label" for="<?php echo e($ob->slug); ?>-<?php echo e($ob->id); ?>">
                <input class="form-check-input  car-models <?php echo e($url); ?> <?php echo e($obj->slug); ?>  <?php echo e($obj->name == 'Spare Parts' || $obj->name == 'Servicing Parts'  ? 'no-validation' : ''); ?>" data-slug="<?php echo e($ob->slug); ?>" data-name="<?php echo e($ob->name); ?>" value="<?php echo e($ob->id); ?>" <?php echo e($helper->check($collections, $ob->id)); ?> type="checkbox" id="<?php echo e($ob->slug); ?>-<?php echo e($ob->id); ?>" name="<?php echo e($name); ?>[]">
                <span role="button"><?php echo e($ob->name); ?></span>
                <a href="<?php echo e(route($model.'.edit',[$url => $ob->id])); ?>">
        ...
        <div class="d-flex">
            <div class="form-check">
                <label class="custom-control-label" for="<?php echo e($ob->slug); ?>-<?php echo e($engine->id); ?>">
                    <input data-slug="<?php echo e($ob->slug); ?>" data-name="<?php echo e($ob->name); ?>" class="form-check-input engine-<?php echo e($ob->slug); ?>" value="<?php echo e($engine->id); ?>" type="checkbox" id="<?php echo e($ob->slug); ?>-<?php echo e($engine->id); ?>" name="engine_id[<?php echo e($ob->id); ?>][]" <?php echo e($helper->check($product->engines, $ob->id, true, $engine->id)); ?>>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php endif; ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/autofactorng/resources/views/includes/edit_children.blade.php ENDPATH**/ ?>