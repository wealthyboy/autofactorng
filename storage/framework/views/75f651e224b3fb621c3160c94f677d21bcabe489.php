...
<div class="row">
<?php echo $__env->make('admin.includes.top',['add' => true, 'name' => 'Discounts'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div class="col-12">
        <div class="card">
            ...
            <form action="<?php echo e(route('discounts.destroy',['discount'=>1])); ?>" method="post" enctype="multipart/form-data" id="form-discounts">
                  ...
                  <?php $__currentLoopData = $discounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $discount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="form-check">
                                <input class="form-check-input" name="selected[]" value="<?php echo e($discount->id); ?>" type="checkbox" id="customCheck1">
                            </div>
                        </div>
                        </td>
                        <td class="font-weight-normal">
                           <span class="my-2 text-xs"><?php echo e($discount->amount); ?>% off </span>
                        </td>
                        <td class="text-xs font-weight-normal">
                        <div class="d-flex align-items-center">
                            <span><?php echo e(optional($discount->category)->name); ?></span>
                        </div>
                        </td>
                        <td class="text-xs font-weight-normal">
                        <div class="d-flex align-items-center">
                            <span><?php echo e($discount->expires); ?></span>
                        </div>
                        </td>
                        <td class="text-xs font-weight-normal">
                        <span class="my-2 text-xs"><?php echo e($discount->created_at->format('d/m/y')); ?> </span>
                        </td>
                        
                        <td class="text-xs font-weight-normal">
                           <a href="<?php echo e(route('discounts.edit',['discount'=> $discount->id])); ?> " rel="tooltip" class="" data-original-title="" title="Edit">
