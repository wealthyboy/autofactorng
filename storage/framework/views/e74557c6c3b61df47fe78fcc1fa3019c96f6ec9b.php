    ...
    <div class="col-md-6">
        <div class="card mt-4" id="password">
            ...
            <div class="card-body pt-0">
                ...
                <form id="" action="<?php echo e(route('promos.store')); ?>" method="post">
                    <?php echo csrf_field(); ?> 
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/autofactorng/resources/views/admin/promo/create.blade.php ENDPATH**/ ?>