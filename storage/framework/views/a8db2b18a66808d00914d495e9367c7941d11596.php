                ...
                <div class="container">
                    ...
                    <div class="header-right w-lg-max">
                        ...
                        <div class="dropdown cart-dropdown">
                            <a href="demo4.html#" title="Cart" class="dropdown-toggle dropdown-arrow cart-toggle" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-display="static">
                ...
                <div class="container">
                    <nav class="main-nav w-100">
                        <ul class="menu">
                            ...
                            <li class="float-right"><a href="demo4.html#" class="pl-5">Special Offer!</a></li>
                        </ul>
                    </nav>
                </div>
                <!-- End .container -->
                    ...
                    <div class="products-slider custom-products owl-carousel owl-theme nav-outer show-nav-hover nav-image-center" data-owl-options="{
                        ...
                        <div class="product-default appear-animate" data-animation-name="fadeInRightShorter">
                            ...
                            <div class="product-details">
                                ...
                                <div class="product-action">
                                    <a href="wishlist.html" class="btn-icon-wish" title="wishlist"><i class="icon-heart"></i></a>
                                    <a href="demo4.html#" class="btn-icon btn-add-cart product-type-simple"><i class="icon-shopping-cart"></i><span>ADD TO CART</span></a>
                                    <a href="ajax/product-quick-view.html" class="btn-quickview" title="Quick View"><i class="fas fa-external-link-alt"></i></a>
                                </div>
                            </div>
                            <!-- End .product-details -->
...
</html><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/autofactorng/resources/views/_partials/header_styles.blade.php ENDPATH**/ ?>