                ...
                <section class="top mb-3">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-4">
                                <h3>Cart Total</h3>
                                <span><span class="bold" id="subtotal">Subtotal:</span> ₦<?php echo e($order->total); ?></span></span> </br>
                                <span><span class="bold" id="subtotal">Shipping:</span> ₦<?php echo e($order->ship_price); ?></span></span> </br>
                                <span><span class="bold" id="subtotal">Coupon:</span> <?php echo e($order->coupon ?  $order->coupon.'  -%'.$order->voucher()->amount .'  off' : '---'); ?></span></span> </br>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th scope="row"><span class="bold">Status:</span> <?php echo e($order_product->status); ?></th>
                                        <td colspan="3">
                                            <div class="media">
                                                <div class="img-container">
                                                    <img class="align-self-start mr-3 img-fluid" src="<?php echo e(optional($order_product->product)->image_tn); ?> " alt="<?php echo e(optional($order_product->product)->name); ?>">
                                                </div>
