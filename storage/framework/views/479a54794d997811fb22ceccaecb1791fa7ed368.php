<div class="d-lg-flex mb-3">
    ...
    <div class="ms-auto my-auto mt-lg-0 mt-4">
        <div class="ms-auto my-auto">
            <?php if( isset($models['unique']['add']) && $models['unique']['add']): ?>
            <a href="<?php echo e(route($models['routes']['create'][0])); ?>" class="btn bg-gradient-primary btn-sm mb-0">+&nbsp; Add New</a>
            <?php endif; ?>
            <?php if( isset($models['unique']['destroy']) && $models['unique']['destroy']): ?>
