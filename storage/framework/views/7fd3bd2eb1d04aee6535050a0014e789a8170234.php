            ...
            <div class="card-body pt-0">
               ...
               <div class="row mt-3">
                  <div class="col-sm-12 col-12">
                     ...
                     <div class="input-group input-group-outline">
                        <textarea type="text" id="m-description" class="form-control" name="descriptionfff" rows="8"><?php echo e(isset($product) ? $product->description : old('description')); ?></textarea>
                     </div>
                  </div>
               </div>
                  ...
                  <div id="j-drop" class="j-activate j-drop">
                     ...
                     <div id="j-details" class="j-details">
                        ...
                        <div id="<?php echo e($image->id); ?>" class="j-complete">
                           <div class="j-preview">
                              <img class="img-thumnail" src="<?php echo e($image->image_l); ?>">
                              <div id="remove_image" class="remove_image remove-image">
                                 <a class="remove-image" data-id="<?php echo e($image->id); ?>" data-randid="<?php echo e($image->id); ?>" data-model="Image" data-type="complete" data-url="<?php echo e($image->image_l); ?>" href="#">Remove</a>
                              </div>
