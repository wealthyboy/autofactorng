         ...
         <div class="card-body pt-0">
            <form id="" action="<?php echo e(route('permissions.update',['permission' => $permission->id ])); ?>" method="post">
               ...
               <div class="input-group input-group-outline">
                  ...
                  <input type="text" class="form-control" name="name" value="<?php echo e($permission->name); ?>" required="true">
               </div>
               <div class="mt-3">
...
<?php $__env->startSection('inline-scripts'); ?><?php $__env->stopSection(); ?>
