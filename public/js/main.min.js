! function() {
    ...
    if ("object" == typeof window)
        if ("IntersectionObserver" in window && "IntersectionObserverEntry" in window && "intersectionRatio" in window.IntersectionObserverEntry.prototype) "isIntersecting" in window.IntersectionObserverEntry.prototype || Object.defineProperty(window.IntersectionObserverEntry.prototype, "isIntersecting", { get: function() { return this.intersectionRatio > 0 } });
            ...
            a.prototype.THROTTLE_TIMEOUT = 100, a.prototype.POLL_INTERVAL = null, a.prototype.USE_MUTATION_OBSERVER = !0, a._setupCrossOriginUpdater = function() { return i || (i = function(t, i) { n = t && i ? u(t, i) : { top: 0, bottom: 0, left: 0, right: 0, width: 0, height: 0 }, e.forEach((function(t) { t._checkForIntersections() })) }), i }, a._resetCrossOriginUpdater = function() { i = null, n = null }, a.prototype.observe = function(t) {
            ...
            }, a.prototype.unobserve = function(t) { this._observationTargets = this._observationTargets.filter((function(e) { return e.element != t })), this._unmonitorIntersections(t.ownerDocument), 0 == this._observationTargets.length && this._unregisterInstance() }, a.prototype.disconnect = function() { this._observationTargets = [], this._unmonitorAllIntersections(), this._unregisterInstance() }, a.prototype.takeRecords = function() { var t = this._queuedEntries.slice(); return this._queuedEntries = [], t }, a.prototype._initThresholds = function(t) { var e = t || [0]; return Array.isArray(e) || (e = [e]), e.sort().filter((function(t, e, i) { if ("number" != typeof t || isNaN(t) || t < 0 || t > 1) throw new Error("threshold must be a number between 0 and 1 inclusively"); return t !== i[e - 1] })) }, a.prototype._parseRootMargin = function(t) { var e = (t || "0px").split(/\s+/).map((function(t) { var e = /^(-?\d*\.?\d+)(px|%)$/.exec(t); if (!e) throw new Error("rootMargin must be specified in pixels or percent"); return { value: parseFloat(e[1]), unit: e[2] } })); return e[1] = e[1] || e[0], e[2] = e[2] || e[0], e[3] = e[3] || e[1], e }, a.prototype._monitorIntersections = function(e) {
                var i = e.defaultView;
                if (i && -1 == this._monitoringDocuments.indexOf(e)) {
                    var n = this._checkForIntersections,
                        s = null,
                        a = null;
                    this.POLL_INTERVAL ? s = i.setInterval(n, this.POLL_INTERVAL) : (r(i, "resize", n, !0), r(e, "scroll", n, !0), this.USE_MUTATION_OBSERVER && "MutationObserver" in i && (a = new i.MutationObserver(n)).observe(e, { attributes: !0, childList: !0, characterData: !0, subtree: !0 })), this._monitoringDocuments.push(e), this._monitoringUnsubscribes.push((function() {
                        var t = e.defaultView;
                ...
                if (-1 != i) {
                    ...
                    if (!this._observationTargets.some((function(t) { var i = t.element.ownerDocument; if (i == e) return !0; for (; i && i != n;) { var s = o(i); if ((i = s && s.ownerDocument) == e) return !0 } return !1 }))) {
                ...
                if ("none" != window.getComputedStyle(e).display) {
                    for (var a, r, l, d, p, f, m, g, v = o, b = h(e), w = !1; !w && b;) {
                        ...
                        if (y && (a = y, r = v, void 0, void 0, void 0, void 0, void 0, void 0, l = Math.max(a.top, r.top), d = Math.min(a.bottom, r.bottom), p = Math.max(a.left, r.left), g = d - l, v = (m = (f = Math.min(a.right, r.right)) - p) >= 0 && g >= 0 && { top: l, bottom: d, left: p, right: f, width: m, height: g } || null), !v) break;
                        b = b && h(b)
                    }
                    return v
                }
                ...
                if (i !== n)
                    for (var o = 0; o < this.thresholds.length; o++) { var s = this.thresholds[o]; if (s == i || s == n || s < i != s < n) return !0 }
    ...
    function s(t) {
        this.time = t.time, this.target = t.target, this.rootBounds = d(t.rootBounds), this.boundingClientRect = d(t.boundingClientRect), this.intersectionRect = d(t.intersectionRect || { top: 0, bottom: 0, left: 0, right: 0, width: 0, height: 0 }), this.isIntersecting = !!t.intersectionRect;
...
function(t) {
    "use strict";
    t.extend(t.easing, { def: "easeOutQuad", swing: function(e, i, n, o, s) { return t.easing[t.easing.def](e, i, n, o, s) }, easeOutQuad: function(t, e, i, n, o) { return -n * (e /= o) * (e - 2) + i }, easeOutQuint: function(t, e, i, n, o) { return n * ((e = e / o - 1) * e * e * e * e + 1) + i } });
    var e, i, n, o, s, a, r, l, c = {
        initialised: !1,
        mobile: !1,
        minipopup: { imageSrc: "", imageLink: "#", name: "", nameLink: "#", content: "has been added to your cart.", action: '<a href="/cart" class="btn viewcart">View Cart</a><a href="/checkout" class="btn btn-dark checkout">Checkout</a>', delay: 90e3, space: 20, template: '<div class="minipopup-box"><div class="product"><figure class="product-media"><a href="{{imageLink}}"><img src="{{imageSrc}}" alt="product" width="60" height="60"></a></figure><div class="product-detail"><a href="{{nameLink}}" class="product-name">{{name}}</a><p>{{content}}</p></div></div><div class="product-action">{{action}}</div><button class="mfp-close"></button></div>' },
        ...
        floatElement: function() {
            t((function() {
                t("body").find("[data-plugin-float-element]:not(.manual)").each((function() {
                    ...
                    if (n && (e = n), "string" == typeof e) try { e = JSON.parse(e.replace(/'/g, '"').replace(";", "")) } catch (t) {}
        ...
        animPlayBtn: function() {
            t(document).on("click", ".anim-play-btn", (function() {
                ...
                e = i.attr("data-animation-name"), i.removeClass(e), setTimeout((function() { i.addClass(e) }), 200)
            }))
        },
        ...
        initCollapsibleWidget: function() { t(".sidebar-wrapper .widget-title").on("click", (function(t) { setTimeout((function() { c.stickySidebar() }), 320) })) },
        countDown: function() {
        ...
        appearAnimate: function() {
            ...
            t('.owl-item [data-animation-name="splitRight"]').each((function() {
                ...
                if (!t(this).hasClass("animated")) {
                    ...
                    var a = setTimeout((function() { s.addClass(i), s.css("animationDuration", o + "ms"), s.addClass("appear-animation-visible") }), parseInt(n || 0));
                ...
                var i;
                t(this).on("translate.owl.carousel", (function(e) { i = t(this).find(".owl-item.active") })), t(this).on("translated.owl.carousel", (function(n) {
                    var o = t(this);
                    ...
                    o.find(".owl-item.active .appear-animate").each((function() {
                        ...
                        var a = setTimeout((function() { s.addClass("appear-animation-visible") }), parseInt(n || 0));
                        e.push(a)
                    }))
                }))
            }))
        ...
        headerSearchToggle: function() {
            t(".header-search").length && t("body").on("click", ".header-search", (function(t) { t.stopPropagation() })).on("click", ".search-toggle", (function(e) {
            ...
            })).on("click", (function(e) { t(".header-search").removeClass("show"), t(".header-search-wrapper").removeClass("show"), t("body").removeClass("is-search-active") }));
            var e = function() {
        ...
        mobileMenu: function() {
            t(".mmenu-btn").on("click", (function(e) {
                var i = t(this).closest("li"),
                    n = i.find("ul").eq(0);
                i.hasClass("open") ? n.slideUp(300, (function() { i.removeClass("open") })) : n.slideDown(300, (function() { i.addClass("open") })), e.stopPropagation(), e.preventDefault()
            }))
        },
        owlCarousels: function() {
            var e = { loop: !0, margin: 0, responsiveClass: !0, nav: !1, navText: ['<i class="icon-angle-left">', '<i class="icon-angle-right">'], dots: !0, autoplay: !1, autoplayTimeout: 15e3, items: 1 },
                ...
                o = {
                    ...
                    ".products-slider": { loop: !1, margin: 20, autoplay: !1, dots: !0, items: 2, responsive: { 576: { items: 3 }, 992: { items: 5 } } },
                    ...
                    ".brands-slider": { loop: !1, margin: 20, autoHeight: !0, autoplay: !1, dots: !1, navText: ['<i class="icon-left-open-big">', '<i class="icon-right-open-big">'], items: 2, responsive: { 0: { items: 2 }, 480: { items: 3 }, 768: { items: 4 }, 991: { items: 5 }, 1200: { items: 6 } } },
                    ".instagram-feed-carousel": { loop: !0, dots: !1, autoplay: !1, responsive: { 0: { items: 2 }, 480: { items: 3 }, 768: { items: 5 }, 992: { items: 6 }, 1200: { items: 7 }, 1400: { items: 8 }, 1600: { items: 9 }, 1800: { items: 10 } } },
            ...
            Object.keys(o).forEach((function(e) { t(e).each((function() { i(t(this), o[e]) })) })), t(".owl-carousel").each((function() { t(this).data("owl.carousel") || i(t(this), i) })), t(".home-slider").on("loaded.owl.lazy", (function(e) { t(e.element).closest(".home-slide").addClass("loaded"), t(e.element).closest(".home-slider").addClass("loaded") })), t(".boxed-slider").on("loaded.owl.lazy", (function(e) { t(e.element).closest(".category-slide").addClass("loaded") })), t(".about-slider").on("loaded.owl.lazy", (function(e) { t(e.element).closest("div").addClass("loaded") })), t(".home-slider.with-dots-container").each((function() {
                var e = t(this),
                    i = e.parent().find(".home-slider-thumbs"),
                    n = i.children();
                n.eq(0).addClass("active"), i.addClass("owl-carousel owl-theme").owlCarousel({ nav: !1, dots: !1, items: 3, margin: 10 }), n.click((function() {
                    var n = t(this),
        ...
        filterSlider: function() {
            ...
            null != e && (noUiSlider.create(e, { start: [0, 1e3], connect: !0, step: 100, margin: 100, range: { min: 0, max: 1e3 } }), e.noUiSlider.on("update", (function(e, i) {
                e = e.map((function(t) { return "$" + parseInt(t) }));
        ...
        countTo: function() {
            t.fn.numerator && t(".count-to").each((function() {
                ...
                t.extend(i, { onComplete: function() { e.data("append") && e.html(e.html() + e.data("append")), e.data("prepend") && e.html(e.data("prepend") + e.html()) } }), e.appear((function() { setTimeout((function() { e.numerator(i) }), 300) }))
            }))
        },
        alert: function() {
            t(".alert-dismissible").each((function() { t(this).append('<button class="alert-close" />') })), t(".alert-dismissible .alert-close").on("click", (function(e) {
                var i = t(this).closest(".alert-dismissible");
                i.fadeOut((function() { i.remove() }))
            }))
        },
        tooltip: function() { t.fn.tooltip && t('[data-toggle="tooltip"]').tooltip({ trigger: "hover focus" }) },
        popover: function() { t.fn.popover && t('[data-toggle="popover"]').popover({ trigger: "focus" }) },
        changePassToggle: function() { t("#change-pass-checkbox").on("change", (function() { t("#account-chage-pass").toggleClass("show") })) },
        changeBillToggle: function() { t("#change-bill-address").on("change", (function() { t("#checkout-shipping-address").toggleClass("show"), t("#new-checkout-address").toggleClass("show") })) },
        ...
        quantityInputs: function(e = "body") { t.fn.TouchSpin && (t(e).find(".vertical-quantity").TouchSpin({ verticalbuttons: !0, verticalup: "", verticaldown: "", verticalupclass: "icon-up-dir", verticaldownclass: "icon-down-dir", buttondown_class: "btn btn-outline", buttonup_class: "btn btn-outline", initval: 1, min: 1 }), t(e).find(".horizontal-quantity").TouchSpin({ verticalbuttons: !1, buttonup_txt: "", buttondown_txt: "", buttondown_class: "btn btn-outline btn-down-icon", buttonup_class: "btn btn-outline btn-up-icon", initval: 1, min: 1 })) },
        ajaxLoading: function() { t("body").append("<div class='ajax-overlay'></div>") },
        wordRotate: function() {
        ...
        toggleFilter: function() { t(".filter-toggle a").click((function(e) { e.preventDefault(), t(".filter-toggle").toggleClass("opened"), t("body").toggleClass("sidebar-opened") })), t(".sidebar-overlay").click((function(e) { t(".filter-toggle").removeClass("opened"), t("body").removeClass("sidebar-opened") })), t(".sort-menu-trigger").click((function(e) { e.preventDefault(), t(".select-custom").removeClass("opened"), t(e.target).closest(".select-custom").toggleClass("opened") })) },
        toggleSidebar: function() { t(".sidebar-toggle").click((function(e) { alert(); e.preventDefault(), t("body").toggleClass("sidebar-opened") })) },
        toggleCart: function() { t(".cart-toggle").click((function() { t("body").toggleClass("cart-opened") })), t(".btnclose").click((function() { t("body").toggleClass("cart-opened") })), t(".box-close").click((function() { t(this).parent().remove() })), t(".cart-overlay").click((function(e) { t("body").removeClass("cart-opened") })) },
        ...
        windowClick: function() { t(document).click((function(e) { t(e.target).closest(".toolbox-item.select-custom").length || t(".select-custom").removeClass("opened") })) },
        popupMenu: function() {
            if (!(t(".popup-menu").length <= 0)) {
                var e = t(".popup-menu-ul"),
                    i = e.parent().width() - e.children().width();
                i >= 0 && e.css("margin-right", "-" + i + "px"), e.css("margin-top", i + "px"), t(".popup-menu-toggler").on("click", (function(e) { e.preventDefault(), t(this).siblings(".popup-menu").addClass("open"), t(document).on("keydown.popup-menu", (function(e) { 27 == e.which && (t(".popup-menu").removeClass("open"), t(document).off("keydown.popup-menu")) })) })), t("body").on("click", ".popup-menu-close", (function(e) { t(".popup-menu").removeClass("open"), t(document).off("keydown.popup-menu"), e.preventDefault() })), t("body").on("click", ".popup-menu-ul li a", (function(e) {
        ...
        topNotice: function() {
            t(".top-notice .mfp-close").length && t("body").on("click", ".top-notice .mfp-close", (function() {
                alert("I'm here")
                t(this).height();
                t(this).closest(".top-notice").fadeOut((function() { t(this).addClass("closed") }))
            }))
        },
        ratingForm: function() {
        ...
        parallax: function() {
            ...
            e.length && e.each((function() {
                ...
                if (r.css({ "background-image": u, "background-size": "cover", "background-position": "50% 0%", position: "absolute", top: 0, left: 0, width: "100%", height: 100 * l.speed + "%" }), e.prepend(r), e.css({ position: "relative", overflow: "hidden" }), !c.mobile || l.enableOnMobile) {
                    var p = function() { o = e.offset(), s = -(d.scrollTop() - (o.top - 100)) / (l.speed + 2), a = s < 0 ? Math.abs(s) : -Math.abs(s), r.css({ transform: "translate3d(0, " + (a - 50 + l.offset) + "px, 0)", "background-position-x": l.horizontalPosition }) };
        ...
        sideMenu: function() { t(".side-menu").length && t("body").on("click", ".side-menu-toggle", (function(e) { t(this).siblings("ul").slideToggle("fast"), t(this).parent().toggleClass("show"), e.stopPropagation() })) },
        productsCartAction: function() {
            t("body").on("click", ".btn-add-cart.product-type-simple", (function(e) {
                var i;
                e.preventDefault(), i = t(this).closest(".product-default").length > 0 ? t(this).closest(".product-default") : t(this).closest(".product-row"), c.miniPopup.open({ name: i.find(".product-title").text(), nameLink: i.find(".product-title > a").attr("href"), imageSrc: i.find("figure img").attr("src"), imageLink: i.find(".product-title > a").attr("href") })
            }))
        },
        productsWishlistAction: function() {
            t("body").on("click", ".btn-icon-wish:not(.added-wishlist)", (function(e) {
                e.preventDefault();
                var i = t(this);
                i.addClass("load-more-overlay loading"), setTimeout((function() { i.removeClass("load-more-overlay loading"), i.addClass("added-wishlist "), "" !== i.find("span").text() && i.find("span").text("BROWSE WISHLIST"), i.attr("title", "Go to Wishlist"), t(".wishlist-popup").addClass("active") }), 1e3), setTimeout((function() { t(".wishlist-popup").removeClass("active") }), 3e3)
            }))
        },
        initPurchasedMinipopup: function() {
            (t(".product-single").length || t(".main-content").length) && setInterval((function() { c.miniPopup.open({ name: "Mobile Speaker", nameLink: "product.html", imageSrc: "assets/images/products/small/product-1.jpg", content: "Someone Purchased", action: '<span class="text-primary" style="font-size: 11px;">12 MINUTES AGO</span>' }) }), 6e4)
        },
        initJqueryParallax: function() { t(".home-slider ul.scene").parallax(), t(".bg-parallax ul.scene").parallax() },
                ...
                n.text("Loading ..."), t.ajax({
                    ...
                    success: function(i) {
                        var s = t(".product-ajax-grid"),
                            a = t(i);
                        setTimeout((function() { a.hide().appendTo(s).fadeIn(), n.text(o), ++e >= 2 && n.hide() }), 350)
                    },
                    failure: function() { n.text("Sorry something went wrong.") }
                })
            }))
        },
        ...
        footerReveal: function() {
            ...
            if (e.length) {
                var i = function() { t(window).width() >= 992 ? (e.parent().css("margin-bottom", e.outerHeight()), e.css("position", "fixed")) : (e.parent().css("margin-bottom", ""), e.css("position", "static")) };
                t(window).resize(i), i()
            }
        },
    ...
    c.initProductSingle = function() {
        ...
        return e.prototype.init = function(e) {
                ...
                var e = this,
                    i = !0;
                e.$selects.each((function() { return this.value || (i = !1) })), e.$items.each((function() {
                    var e = t(this);
        ...
        init: function() {
            ...
            e.className = "minipopup-area", t(".page-wrapper")[0].appendChild(e), (i = t(e)).on("click", ".mfp-close", (function(e) { self.close(t(this).closest(".minipopup-box").index()) }));
        ...
        open: function(e, s) {
            ...
            u = t(d(h.template, h)), p.space = h.space, u.appendTo(i).css("top", -n).find("img")[0].onload = function() { n += u[0].offsetHeight + p.space, u.addClass("active"), u.offset().top - window.pageYOffset < 0 && (p.close(), u.css("top", -n + u[0].offsetHeight + p.space)), u.on("mouseenter", (function() { p.pause() })).on("mouseleave", (function() { p.resume() })).on("touchstart", (function(t) { p.pause(), t.stopPropagation() })).on("mousedown", (function() { t(this).addClass("focus") })).on("mouseup", (function() { p.close(t(this).index()) })), t("body").on("touchstart", (function() { p.resume() })), o.push(u), a.push(h.delay), a.length > 1 || (r = setInterval(l, 200)), s && s(u) }
        },
        close: function(t) {
            var e = void 0 === t ? 0 : t,
                i = o.splice(e, 1)[0];
            a.splice(e, 1)[0], n -= i[0].offsetHeight + this.space, i.removeClass("active"), setTimeout((function() { i.remove() }), 300), o.forEach((function(t, i) { i >= e && t.hasClass("active") && t.stop(!0, !0).animate({ top: parseInt(t.css("top")) + t[0].offsetHeight + 20 }, 600, "easeOutQuint") })), o.length || clearTimeout(r)
        },
        pause: function() { s = !0 },
        resume: function() { s = !1 }
    });
    var d = function(t, e) { return t.replace(/\{\{(\w+)\}\}/g, (function() { return e[arguments[1]] })) };
    jQuery(document).ready((function() { c.init(), setTimeout((() => { c.appearAnimate(), c.scrollBtnAppear() }), 500) })), t(window).on("load", (function() { t("body").addClass("loaded") })), t(window).on("scroll", (function() { c.scrollBtnAppear() }))
}(jQuery);