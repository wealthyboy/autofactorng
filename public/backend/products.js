...
function addProductRow() {
    ...
    html += '<div class="input-group input-group-outline">';
    html += '<input type="text" class="form-control" placeholder="Product Name" name="products[product_name][]">';
    html += '</div>';
    html += '</div>';
    html += '<div class="col-sm-3 col-12">';
    html += '<div class="input-group input-group-outline">';
    html += '<input type="number" class="form-control" placeholder="Quantity" name="products[quantity][]">';
    html += '</div>';
    html += '</div>';
    html += '<div class="col-sm-3 col-12">';
    html += '<div class="input-group input-group-outline">';
    html += '<input type="number" class="form-control" placeholder="Price" name="products[price][]">';
    html += '</div>';
    html += '</div>';
    html += '<div class="col-sm-1">';
