    ...
    <div class="container-fluid">
        <div class="row how-to justifiy-content-center">
            ...
            <div id="content" class="col-md-6  mb-9 p-">
                ...
                <div style="height: 45px; " class="mt-3  d-none d-lg-block  d-xl-block mb-4"> <?php echo  html_entity_decode($video->description)  ?> </div>
                <div style="height:" class="mt-3  d-md-none d-lg-none d-sm-block mb-4"> <?php echo  html_entity_decode($video->description)  ?> </div>
                <div style="height: 65px;  " class="mt-3 d-md-block d-lg-none d-sm-none d-xl-none d-xs-none mb-4"> <?php echo  html_entity_decode($video->description)  ?> </div>
