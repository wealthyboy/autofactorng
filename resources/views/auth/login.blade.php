...
<div class="container-fluid px-0">
    <div class="row">
        ...
        <div style="background-image: url('/images/utils/sign.jpeg'); background-size: contain; background-repeat:no-repeat; height: 100vh !important;" class="  d-none d-lg-block d-md-block d-xl-block col-12  col-md-7  position-relative bg-gradient-primary h-100  px-7 border-radius-lg">
