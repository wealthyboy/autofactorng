            ...
            <div class="content p-5">
                ...
                <form id="customer-survey-form" method="POST" action="{{ route('customer-survey.submit') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="customer_name" value="{{ old('customer_name') }}" class="form-control" placeholder="Enter your name">
                    </div>
                    ...
                    <h5 class="mt-4">Section 1: Customer Service Experience</h5>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="response_time" id="response_time_{{ \Illuminate\Support\Str::slug($option) }}" value="{{ $option }}" {{ old('response_time') === $option ? 'checked' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="support_staff" id="support_staff_{{ \Illuminate\Support\Str::slug($option) }}" value="{{ $option }}" {{ old('support_staff') === $option ? 'checked' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        @foreach (['Very Satisfied','Satisfied','Neutral','Dissatisfied','Very Dissatisfied'] as $option)
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="delivery_satisfaction" id="delivery_satisfaction_{{ \Illuminate\Support\Str::slug($option) }}" value="{{ $option }}" {{ old('delivery_satisfaction') === $option ? 'checked' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="delivered_on_time" id="delivered_on_time_{{ \Illuminate\Support\Str::slug($option) }}" value="{{ $option }}" {{ old('delivered_on_time') === $option ? 'checked' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="condition" id="condition_{{ \Illuminate\Support\Str::slug($option) }}" value="{{ $option }}" {{ old('condition') === $option ? 'checked' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        @foreach (['Yes','No'] as $option)
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="accurate_description" id="accurate_description_{{ \Illuminate\Support\Str::slug($option) }}" value="{{ $option }}" {{ old('accurate_description') === $option ? 'checked' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        @foreach (['Very Satisfied','Satisfied','Neutral','Dissatisfied','Very Dissatisfied'] as $option)
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="overall_satisfaction" id="overall_satisfaction_{{ \Illuminate\Support\Str::slug($option) }}" value="{{ $option }}" {{ old('overall_satisfaction') === $option ? 'checked' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="likely_to_purchase_again" id="likely_to_purchase_again_{{ \Illuminate\Support\Str::slug($option) }}" value="{{ $option }}" {{ old('likely_to_purchase_again') === $option ? 'checked' : '' }}>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        form.addEventListener('submit', function(e) {
            var hasText = form.customer_name.value.trim() !== '' ||
                form.email.value.trim() !== '' ||
                form.improvement_suggestions.value.trim() !== '';
            ...
            var hasRadio = radioGroups.some(function(name) {
                return form.querySelector('input[name="' + name + '"]:checked') !== null;
            });

            var hasCheckbox = form.querySelector('input[name="support_staff"]:checked') !== null;

            if (!hasText && !hasRadio && !hasCheckbox) {
                e.preventDefault();
                errorBox.textContent = 'Please answer at least one question before submitting.';
