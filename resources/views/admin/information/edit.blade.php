               ...
               <div class="row mt-3">
                  <div class="col-sm-12 col-12">
                     <div class="input-group input-group-outline">
                        ...
                        <input type="number" class="form-control" name="sort_order" value="{{ $information->sort_order }}">
                     </div>
                  </div>
               </div>
               ...
               <div class="row mt-3">
                  <div class="col-sm-12 col-12">
                     <div class="input-group input-group-outline">
                        ...
                        <input type="text" class="form-control" name="custom_link" value="{{ $information->link }}">
                     </div>
                  </div>
               </div>
               <div class="row mt-3">
                  <div class="col-sm-12 col-12">
                     <div class="input-group input-group-outline">
                        ...
                        <input type="text" class="form-control" name="meta_title" value="{{ $information->meta_title }}">
                     </div>
                  </div>
               </div>
                  ...
                  <div class="col-md-12">
                     <div class="form-group">
                        ...
                        <div class="form-group ">
                           ...
                           <textarea name="description" id="description" class="form-control" required rows="20">{{ $information->description }}</textarea>
                        </div>
                     </div>
                  </div>
               </div>
