            ...
            <div class="card-body pt-0">
               ...
               <div class="row">
                  <div class="col-sm-6 col-12">
                     <div class="input-group input-group-outline">
                        ...
                        <input type="text" class="form-control" name="product_name" value="{{ isset($product) ? $product->product_name : old('product_name') }}">
                     </div>
                  </div>
                  <div class="col-sm-6 col-12">
                     <div class="input-group input-group-outline">
               ...
               <div class="row mt-3">
                  <div class="col-sm-4 col-12">
                     <div class="input-group input-group-outline">
                        ...
                        <input type="number" class="form-control" name="radius" value="{{ isset($product) ? $product->radius : old('product_radius') }}">
                     </div>
                  </div>
                  ...
                  <div class="col-sm-4 col-12">
                     <div class="input-group input-group-outline">
                        ...
                        <input type="number" class="form-control" name="width" value="{{ isset($product) ? $product->width : old('width') }}">
                     </div>
                  </div>
                  ...
                  <div class="col-sm-4 col-12">
                     <div class="input-group input-group-outline">
                        ...
                        <input type="number" class="form-control" name="height" value="{{ isset($product) ? $product->height : old('height') }}">
                     </div>
                  </div>
               </div>
               ...
               <div class="row mt-3">
                  <div class="col-sm-12 col-12">
                     <div class="input-group input-group-outline">
                        ...
                        <input type="text" class="form-control" name="title" value="{{ isset($product) ? $product->title : old('meta_title') }}">
                     </div>
                  </div>
               </div>
               ...
               <div class="row mt-3">
                  <div class="col-sm-12 col-12">
                     <div class="input-group input-group-outline">
                        ...
                        <input type="text" class="form-control" name="keywords" value="{{ isset($product) ? $product->keywords : old('keywords') }}">
               ...
               <div class="row mt-3">
                  <div class="col-sm-12 col-12">
                     ...
                     <div class="input-group input-group-outline">
                        <textarea type="text" class="form-control" name="meta_description" rows="8">{{ isset($product) ? $product->meta_description : old('meta_description') }}</textarea>
                     </div>
                  </div>
               </div>
               ...
               <div class="row mt-3">
                  <div class="col-sm-12 col-12">
                     ...
                     <div class="input-group input-group-outline">
                        <textarea type="text" id="m-description" class="form-control" name="descriptionfff" rows="8">{{ isset($product) ? $product->description : old('description') }}</textarea>
                     </div>
                  </div>
               </div>
               ...
               <div class="row mt-3">
                  <div class="col-sm-12 col-12">
                     ...
                     <div class="input-group input-group-outline">
                        <textarea type="text" class="form-control" name="phy_descfff" rows="8" id="phy_description">
                        {{ $product->phy_desc }}
                        </textarea>
                     </div>
                  </div>
                                       ...
                                       <button class="accordion-button border-bottom font-weight-bold collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne{{ $attribute->id }}" aria-expanded="false" aria-controls="collapseOne">
                                          <div class=" form-check px-0 ">
                                             <label class="custom-control-label" for="{{ $attribute->name }}-{{ $attribute->id }}">
                                                <input {{ $helper->check($product->attributes, $attribute->id) }} data-name="{{ $attribute->name }}" data-slug="{{ $attribute->slug }}" class="form-check-input parent-attr" value="{{ $attribute->id }}" type="checkbox" id="{{ $attribute->name }}-{{ $attribute->id }}" name="attribute_id[]">
                  ...
                  <div class="parent" value="{{ $category->id }}">
                     ...
                     <div class="form-check ">
                        ...
                        <label class="custom-control-label" for="{{ $category->name }}-{{ $category->id }}">
                           <input class="form-check-input {{ $category->name == 'Spare Parts' || $category->name == 'Servicing Parts'  ? 'no-validation' : '' }}" {{ $helper->check($product->categories, $category->id) }} value="{{ $category->id }}" type="checkbox" id="{{ $category->name }}-{{ $category->id }}" name="category_id[]">
                           ...
                           <tbody class="related_products">
                              ...
                              <tr class="">
                                 <td class="">
                                    <div class="checkbox">
                                       <label>
                                          <input type="checkbox" name="po[{{ $related_product->id }}]" value="{{ $related_product->related_id }}" disabled checked />
                                       </label>
                                    </div>
                                 </td>
                                 <td class="text-left p">
                                    <a class="#" href="#"> {{ optional($related_product->product)->name }}</a>
                                 </td>

                                 <td class="text-left"><a class="remove_related_product" href="/admin/related_products/{{ $related_product->id }}"><i class="fa fa-trash"></i> Delete</a></td>
                              </tr>
                              @endforeach
                           </tbody>
                        </table>
