            ...
            <div class="card-body pt-0">
               ...
               <div class="row mt-3">
                  <div class="col-sm-12 col-12">
                     ...
                     <div class="input-group input-group-outline">
                        <textarea id="m-description" type="text" class="form-control" name="description" rows="8" required>{{ isset($product) ? $product->description : old('description') }}</textarea>
                     </div>
                  </div>
               </div>
               ...
               <div class="row mt-3">
                  <div class="col-sm-12 col-12">
                     ...
                     <div class="input-group input-group-outline">
                        <textarea style="width: 100%;" type="text" class="form-control" name="phy_descfff" rows="8" id="phy_description">
                        </textarea>
                     </div>
                  </div>
               </div>
                                       ...
                                       <button class="accordion-button border-bottom font-weight-bold collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne{{ $attribute->id }}" aria-expanded="false" aria-controls="collapseOne">
                                          <div class=" form-check">
                                             <label class="custom-control-label" for="{{ $attribute->name }}-{{ $attribute->id }}">
                                                <input data-name="{{ $attribute->name }}" data-slug="{{ $attribute->slug }}" class="form-check-input parent-attr" value="{{ $attribute->id }}" type="checkbox" id="{{ $attribute->name }}-{{ $attribute->id }}" name="attribute_id[]">
...
@include('admin.products.category_filter_script')
