...
<div class="row">
    ...
    @if ( isset($models['unique']['forum']) && $models['unique']['forum'])
    <div class="row">
        <div class="card mb-3">
                    ...
                    <table class="table table-flush dataTable-table  align-items-center mb-0">
                        ...
                        <tbody>
                            ...
                            <tr class="table-body">
                                ...
                                @if (isset($models['unique']['pin']) && $models['unique']['pin'])
                                <td>
                                    <a href="/admin/forums?pin={{  isset($models['items'][0][$key]['Id']) ?  $models['items'][0][$key]['Id'] : null }}" data-bs-toggle="tooltip" data-bs-original-title="Pin/Unpin">
                                        <i class="material-symbols-outlined text-secondary position-relative text-lg">push_pin</i>
                                    </a>
                                </td>
                                @endif
            ...
            <div class="row justify-content-center">
                <div class="col-6 col-sm-4 col-md-3 col-lg-12">
                    <div href="#" class="icon-box nounderline text-center p-5">
                        <i class=""></i>
                        <h5 class="porto-sicon-title mx-2 text-sm">{{ $message  ??  "You have no records"}}</h5>
                    </div>
                </div>
            </div>
        </div>
