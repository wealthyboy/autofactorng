...
@include('admin.analytics._chart', ['chartTitle' => 'New customers — six-month trend'])
<div class="card mb-4"><div class="card-header pb-0"><h6>Top buying customers</h6></div><div class="card-body px-0 pb-2"><div class="table-responsive"><table class="table align-items-center mb-0"><thead><tr><th>Customer</th><th class="text-end">Orders</th><th class="text-end">Spend</th></tr></thead><tbody>
