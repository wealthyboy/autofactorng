               ...
               <div class="row mt-3">
                  <div class="col-sm-12 col-12">
                     <div class="input-group input-group-outline">
                        ...
                        <input type="text" value="{{ isset($order) ? $order->email : null }}" class="form-control" name="subject" required>
                     </div>
                  </div>
                  ...
                  <div class="col-sm-12 mt-3 col-12">
                     <div class="input-group input-group-outline">
                        ...
                        <input type="text" value="{{ isset($order) ? $order->first_name : null }}" class="form-control" name="first_name">
                     </div>
                  </div>
                  <div class="col-sm-12 col-12 mt-3">
                     <div class="input-group input-group-outline">
                        <label class="form-label">Phone Number</label>
                        <input name="phone_number" value="{{ isset($order) ? $order->phone_number : null }}" class="form-control " type="text">
                     </div>
                  </div>
                  <div class="col-sm-12 col-12 mt-3">
                     <div class="input-group input-group-outline">
                        <label class="form-label">Payment</label>
                        <input name="payment_type" value="{{  isset($order) ? $order->payment_type : null }}" class="form-control" type="text">
                     </div>
                  </div>
               </div>
               ...
               <div class="row mt-3">
                  <div class="col-sm-12 col-12">
                     <div class="input-group input-group-outline">
                        ...
                        <input type="text" value="{{ isset($order) ? $order->address : null }}" class="form-control" name="address" id="address">
                     </div>
                  </div>
                  <div class="col-sm-12 col-12 mt-3">
                     <div class="input-group input-group-outline">
                        <label class="form-label"> Land Mark</label>
                        <input type="text" value="{{ isset($order)? $order->landmark : null }}" class="form-control" name="landmark" id="land_mark">
                     </div>
                  </div>
