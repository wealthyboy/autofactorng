   ...
   <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
      ...
      <div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
         <ul class="navbar-nav">
            ...
            <li class="nav-item">
               <a class="nav-link text-white {{ $helper->active_link(['abandoned-carts']) }}" href="{{ route('admin.abandoned-carts.index') }}">
                  <i class="material-symbols-outlined opacity-10">remove_shopping_cart</i>
                  <span class="nav-link-text ms-2 ps-1"> Abandoned Carts </span>
               </a>
            </li>
            <li class=" nav-item">
