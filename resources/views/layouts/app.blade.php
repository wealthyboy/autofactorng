               ...
               <nav class="main-nav w-100 ">
                  <div class="d-flex align-items-center">
                     ...
                     <div class="menu-i   menu-i  w-25 ms-5">
                        <button data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo" class="nav-btn border-0 w-100 mb-0">
         ...
         <div style="max-width: 984px" class="modal-dialog">
            <div class="modal-content">
               <div class="modal-header  px-5">
                  <h5 class="modal-title" id="exampleModalLabel">WHAT ARE YOU WORKING ON TODAY?</h5>
               ...
               <div class="modal-body px-5 bg-light">
                  ...
                  <div class=" d-flex justify-content-between align-content-center pt-2">
                     <modal-make-model-year :years="{{ collect($yrs) }}"></make-model-year>
                  </div>
               </div>
