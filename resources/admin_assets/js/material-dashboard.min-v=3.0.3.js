...
function sidebarType(e) {
    ...
    if (c.classList.add(a), "bg-transparent" == a || "bg-white" == a) { var u = document.querySelectorAll(".sidenav .text-white"); for (let e = 0; e < u.length; e++) u[e].classList.remove("text-white"), u[e].classList.add("text-dark") } else { var m = document.querySelectorAll(".sidenav .text-dark"); for (let e = 0; e < m.length; e++) m[e].classList.add("text-white"), m[e].classList.remove("text-dark") }
    if ("bg-transparent" == a && n) { m = document.querySelectorAll(".navbar-brand .text-dark"); for (let e = 0; e < m.length; e++) m[e].classList.add("text-white"), m[e].classList.remove("text-dark") }
...
window.addEventListener("resize", navbarColorOnResize),
    ...
    window.onload = function() {
        for (var e = document.querySelectorAll("input"), t = 0; t < e.length; t++) e[t].value !== '' && e[t].parentElement.classList.add("is-filled"),
        ...
        for (var a = document.querySelectorAll(".btn"), t = 0; t < a.length; t++) a[t].addEventListener("click", function(e) {
            ...
            (a = document.createElement("span")).classList.add("ripple"), a.style.width = a.style.height = Math.max(t.offsetWidth, t.offsetHeight) + "px", t.appendChild(a), a.style.left = e.offsetX - a.offsetWidth / 2 + "px", a.style.top = e.offsetY - a.offsetHeight / 2 + "px", a.classList.add("ripple"), setTimeout(function() { a.parentElement.removeChild(a) }, 600)
        }, !1)
    };
var material = {
    ...
    showSwal: function(e) {
        if ("basic" == e) {
            ...
            i.fire({ title: "Are you sure?", text: "You won't be able to revert this!", icon: "warning", showCancelButton: !0, confirmButtonText: "Yes, delete it!" }).then(e => { e.isConfirmed && Swal.fire("Deleted!", "Your file has been deleted.", "success") })
