...
function(t) { "use strict";
    t.extend(t.easing, { def: "easeOutQuad", swing: function(e, i, n, o, s) { return t.easing[t.easing.def](e, i, n, o, s) }, easeOutQuad: function(t, e, i, n, o) { return -n * (e /= o) * (e - 2) + i }, easeOutQuint: function(t, e, i, n, o) { return n * ((e = e / o - 1) * e * e * e * e + 1) + i } }); var e, i, n, o, s, a, r, l, c = { initialised: !1, mobile: !1, minipopup: { imageSrc: "", imageLink: "#", name: "", nameLink: "#", content: "has been added to your cart.", action: '<a href="cart.html" class="btn viewcart">View Cart</a><a href="checkout.html" class="btn btn-dark checkout">Checkout</a>', delay: 4e3, space: 20, template: '<div class="minipopup-box"><div class="product"><figure class="product-media"><a href="{{imageLink}}"><img src="{{imageSrc}}" alt="product" width="60" height="60"></a></figure><div class="product-detail"><a href="{{nameLink}}" class="product-name">{{name}}</a><p>{{content}}</p></div></div><div class="product-action">{{action}}</div><button class="mfp-close"></button></div>' }, init: function() { this.initialised || (this.initialised = !0, this.checkMobile(), this.stickyHeader(), this.headerSearchToggle(), this.mMenuIcons(), this.mMenuToggle(), this.mobileMenu(), this.scrollToTop(), this.quantityInputs(), this.alert(), this.countTo(), this.tooltip(), this.popover(), this.changePassToggle(), this.changeBillToggle(), this.catAccordion(), this.toggleFilter(), this.toggleSidebar(), this.toggleCart(), this.linkToTab(), this.productTabSroll(), this.scrollToElement(), this.loginPopup(), this.productManage(), this.ratingTooltip(), this.windowClick(), this.popupMenu(), this.topNotice(), this.ratingForm(), this.parallax(), this.sideMenu(), this.miniPopup.init(), this.initProductSinglePage(), this.initCollapsibleWidget(), this.initProductsScrollLoad(".scroll-load"), this.productsCartAction(), this.productsWishlistAction(), this.initPurchasedMinipopup(), this.initJqueryParallax(), this.ajaxLoadProducts(), this.categoryNavScroll(), this.wordRotate(), this.footerReveal(), this.videoModal(), this.animPlayBtn(), t.fn.superfish && this.menuInit(), t.fn.countdown && this.countDown(), t.fn.owlCarousel && this.owlCarousels(), "object" == typeof noUiSlider && this.filterSlider(), t.fn.themeSticky && this.stickySidebar(), t.fn.magnificPopup && this.lightBox(), t.fn.isotope && this.isotopes(), t.fn.elevateZoom && this.zoomImage(), t.fn.themePluginFloatElement && this.floatElement()) }, floatElement: function() { t((function() { t("body").find("[data-plugin-float-element]:not(.manual)").each((function() { var e, i = t(this),
                        n = i.data("plugin-options"); if (n && (e = n), "string" == typeof e) try { e = JSON.parse(e.replace(/'/g, '"').replace(";", "")) } catch (t) {}
                    i.themePluginFloatElement(e) })) })) }, animPlayBtn: function() { t(document).on("click", ".anim-play-btn", (function() { var e, i = t(this).closest(".anim-pane").find("[data-animation-name]");
            ...
            t('.owl-item [data-animation-name="splitRight"]').each((function() { var e = t(this).text(),
                ...
                t(this).on("translate.owl.carousel", (function(e) { i = t(this).find(".owl-item.active") })), t(this).on("translated.owl.carousel", (function(n) { var o = t(this); if (t(this).find(".owl-item.active")[0] !== i[0]) { for (var s = 0; s < e.length; s++) clearTimeout(e[s]);
                    ...
                    o.find(".owl-item.active .appear-animate").each((function() { var i, n, o, s = t(this);
            ...
            e = t(".product-slider-container").length > 0 ? t(".product-single-carousel .owl-item:not(.cloned) img") : t(".product-single-gallery img"), t(".media-with-zoom").length > 0 && (e = t(".media-with-zoom .owl-carousel .owl-item:not(.cloned) img")), t(".team-section").length > 0 && (e = t(".team-section img")), e.each((function() { i.push({ src: t(this).attr("data-zoom-image") }) })), t(".prod-full-screen").click((function(e) { var n;
                ...
                t("#product-reviews-content").length && setTimeout((function() { var e = t("#product-reviews-content").offset().top - 60;
            ...
            t(".grid").each((function() { var i = t(this),
                ...
                i.addClass("load-more-overlay loading"), setTimeout((function() { i.removeClass("load-more-overlay loading"), i.addClass("added-wishlist "), "" !== i.find("span").text() && i.find("span").text("BROWSE WISHLIST"), i.attr("title", "Go to Wishlist"), t(".wishlist-popup").addClass("active") }), 1e3), setTimeout((function() { t(".wishlist-popup").removeClass("active") }), 3e3) })) }, initPurchasedMinipopup: function() {
            (t(".product-single").length || t(".main-content").length) && setInterval((function() { c.miniPopup.open({ name: "Mobile Speaker", nameLink: "product.html", imageSrc: "assets/images/products/small/product-1.jpg", content: "Someone Purchased", action: '<span class="text-primary" style="font-size: 11px;">12 MINUTES AGO</span>' }) }), 6e4) }, initJqueryParallax: function() { t(".home-slider ul.scene").parallax(), t(".bg-parallax ul.scene").parallax() }, ajaxLoadProducts: function() { var e = 0;
    ...
    c.initProductSingle = function() {
        function e(t) { return this.init(t) } var i = function(t) { var e = t.$thumbsWrap.offset().top,
            ...
            function(t, i) { return t ? new e(t.eq(0), i) : null } }(), c.initProductSinglePage = function() { return (e = t(".product-single-container")).length ? null === c.initProductSingle(e) ? null : void 0 : null }, c.miniPopup = (n = 0, o = [], s = !1, a = [], r = !1, l = function() { if (!s)
            for (var t = 0; t < a.length; ++t)(a[t] -= 200) <= 0 && this.close(t--) }, { init: function() { var e = document.createElement("div");
            e.className = "minipopup-area", t(".page-wrapper")[0].appendChild(e), (i = t(e)).on("click", ".mfp-close", (function(e) { self.close(t(this).closest(".minipopup-box").index()) })); var n = document.createElement("div"),
                o = document.createElement("div");
            n.className = "wishlist-popup", o.className = "wishlist-popup-msg", o.innerText = "Product added!", t(".page-wrapper")[0].appendChild(n), t(".wishlist-popup").append(o), this.close = this.close.bind(this), l = l.bind(this) }, open: function(e, s) { var u, p = this,
                h = t.extend(!0, {}, c.minipopup, e);
            u = t(d(h.template, h)), p.space = h.space, u.appendTo(i).css("top", -n).find("img")[0].onload = function() { n += u[0].offsetHeight + p.space, u.addClass("active"), u.offset().top - window.pageYOffset < 0 && (p.close(), u.css("top", -n + u[0].offsetHeight + p.space)), u.on("mouseenter", (function() { p.pause() })).on("mouseleave", (function() { p.resume() })).on("touchstart", (function(t) { p.pause(), t.stopPropagation() })).on("mousedown", (function() { t(this).addClass("focus") })).on("mouseup", (function() { p.close(t(this).index()) })), t("body").on("touchstart", (function() { p.resume() })), o.push(u), a.push(h.delay), a.length > 1 || (r = setInterval(l, 200)), s && s(u) } }, close: function(t) { var e = void 0 === t ? 0 : t,
                i = o.splice(e, 1)[0];
            a.splice(e, 1)[0], n -= i[0].offsetHeight + this.space, i.removeClass("active"), setTimeout((function() { i.remove() }), 300), o.forEach((function(t, i) { i >= e && t.hasClass("active") && t.stop(!0, !0).animate({ top: parseInt(t.css("top")) + t[0].offsetHeight + 20 }, 600, "easeOutQuint") })), o.length || clearTimeout(r) }, pause: function() { s = !0 }, resume: function() { s = !1 } }); var d = function(t, e) { return t.replace(/\{\{(\w+)\}\}/g, (function() { return e[arguments[1]] })) };
