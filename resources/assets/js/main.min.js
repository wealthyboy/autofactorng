! function () {
    ...
    function (t) {
        ...
        var e, i, n, o, s, a, r, l, c = {
            ...
            owlCarousels: function () {
                var e = { loop: !0, margin: 0, responsiveClass: !0, nav: !1, navText: ['<i class="icon-angle-left">', '<i class="icon-angle-right">'], dots: !0, autoplay: !1, autoplayTimeout: 15e3, items: 1 },
                    ...
                    o = {
                        ...
                        ".custom-single-default .custom-single-carousel": {
                            margin: 0,
                            nav: 0,
                            loop: 1,
                            dotsContainer: "#custom-carousel-dots",
                            autoplay: !1,
                            onResized: function () {
                                // var e = this.$element;
            ...
            productsCartAction: function () {
                t("body").on("click", ".btn-add-cart.product-type-simple", (function (e) {
                    var i;
                    e.preventDefault(), i = t(this).closest(".product-default").length > 0 ? t(this).closest(".product-default") : t(this).closest(".product-row"),
                        c.miniPopup.open({
        ...
        jQuery(document).ready((function () { c.init(), setTimeout((() => { c.appearAnimate(), c.scrollBtnAppear() }), 500) })), t(window).on("load", (function () { })), t(window).on("scroll", (function () { c.scrollBtnAppear() }))
    }(jQuery);