...
function(t) {
    ...
    var e, i, n, o, s, a, r, l, c = {
        ...
        owlCarousels: function() {
            var e = { loop: !0, margin: 0, responsiveClass: !0, nav: !1, navText: ['<i class="icon-angle-left">', '<i class="icon-angle-right">'], dots: !0, autoplay: !1, autoplayTimeout: 15e3, items: 1 },
                ...
                o = {
                    ...
                    ".related-products-slider": { loop: !1, margin: 10, autoplay: !1, dots: !1, items: 2, responsive: { 576: { items: 3 }, 992: { items: 8 } } },
        ...
        //     })
        // },
        toggleCart: function() { t(".cart-toggle").click((function() { t("body").toggleClass("cart-opened") })), t(".btn-close").click((function() { t("body").toggleClass("cart-opened") })), t(".box-close").click((function() { t(this).parent().remove() })), t(".cart-overlay").click((function(e) { t("body").removeClass("cart-opened") })) },
