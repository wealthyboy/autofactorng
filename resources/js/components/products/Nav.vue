<template>
    <nav class="toolbox sticky-header mt-4" data-sticky-options="{'mobile': true}">
        ...
        <div class="toolbox-right">
            <div class="toolbox-item toolbox-sort">
                ...
                <div class="select-custom">
                    <select @change="sort($event)" name="orderby" class="form-control orderby">
            ...
            <div class="toolbox-item layout-modes">
                <a href="#" class="layout-btn btn-grid" title="Grid" :class="{ active: listing == 'Grid' }"
                    @click.prevent="list('Grid')">
                    <i class="icon-mode-grid fs-2"></i>
                </a>

                <a href="#" class="layout-btn btn-list" title="List" :class="{ active: listing == 'List' }"
