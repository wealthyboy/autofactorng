    ...
    <div class="col-md-9 col-6">
      ...
      <div class="product-item-prices d-flex">
        ...
        >
          ...
          <span class="product--price text-danger">{{ $filters.formatNumber(cart.product.formatted_sale_price) }}</span>
        ...
        >
          ...
          <span class="product--price retail--price me-3">{{ $filters.formatNumber(cart.price) }} x {{ cart.quantity }}</span>
          <span class="retail--title"></span>
        </div>
